...
public class EdgeWebMediaToRelatedMedia {
     ...
     * @param edges
     */
    public EdgeWebMediaToRelatedMedia(List<Object> edges) {
        super();
        this.edges = edges;
    }
    ...
    public String toString() {
        ...
        sb.append(EdgeWebMediaToRelatedMedia.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("edges");
        sb.append('=');
