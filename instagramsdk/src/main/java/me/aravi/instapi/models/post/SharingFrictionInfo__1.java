...
public class SharingFrictionInfo__1 {
     ...
     */
    public SharingFrictionInfo__1(Boolean shouldHaveSharingFriction, Object bloksAppUrl) {
        super();
    ...
    public String toString() {
        ...
        sb.append(SharingFrictionInfo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
