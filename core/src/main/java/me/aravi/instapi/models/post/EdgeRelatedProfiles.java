...
public class EdgeRelatedProfiles {
     ...
     * @param edges
     */
    public EdgeRelatedProfiles(List<Object> edges) {
        super();
        this.edges = edges;
    }
    ...
    public String toString() {
        ...
        sb.append(EdgeRelatedProfiles.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("edges");
        sb.append('=');
