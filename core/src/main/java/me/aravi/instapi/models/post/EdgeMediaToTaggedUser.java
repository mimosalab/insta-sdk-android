...
public class EdgeMediaToTaggedUser {
     ...
     * @param edges
     */
    public EdgeMediaToTaggedUser(List<Object> edges) {
        super();
        this.edges = edges;
    }
    ...
    public String toString() {
        ...
        sb.append(EdgeMediaToTaggedUser.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("edges");
        sb.append('=');
